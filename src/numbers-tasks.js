...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  const lenghtAVector = getDistanceBetweenPoints(x1, y1);
  const lenghtBVector = getDistanceBetweenPoints(x2, y2);
  return Math.acos(
    Math.cos(scalarProizvedenie / (lenghtAVector * lenghtBVector))
  );
}
